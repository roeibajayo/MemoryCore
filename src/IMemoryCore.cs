...
public interface IMemoryCore : IMemoryCache
{
    ...
    /// </summary>
    void Add(string key, object value, TimeSpan absoluteExpiration, string[]? tags = null);

    /// <summary>
    /// Add a new item to the cache with a sliding expiration.
    /// </summary>
    void AddSliding(string key, object value, TimeSpan slidingExpiration, TimeSpan? absoluteExpiration = null, string[]? tags = null);
    ...
    T? TryGetOrAdd<T>(string key, Func<T> getValueFunction, TimeSpan absoluteExpiration,
        bool allowDefault = false, bool forceSet = false, string[]? tags = null);
